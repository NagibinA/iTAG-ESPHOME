...
|   -- | -- | -- |
|   <sub>Брелок с кнопкой, батареку передает через нотификацию</sub>  |<sub>Брелок с кнопкой, батарейку не читает (заглушка 100%)</sub> | <sub>Брелок без кнопки, батарейку передает через чтение</sub> | 
